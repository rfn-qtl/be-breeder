...
# rownames(solution[[2]]$uhat)<-c(unique(c(data[,1],data[,2])),paste(data[,1],data[,2],sep = "_x_"))
# rownames(solution[[2]]$Xsqtestu)<-c(unique(c(data[,1],data[,2])),paste(data[,1],data[,2],sep = "_x_"))
# rownames(solution[[2]]$Xsqtestbeta)<-c(unique(c(data[,1],data[,2])),paste(data[,1],data[,2],sep = "_x_"))
# rownames(solution[[2]]$pvalu)<-c(unique(c(data[,1],data[,2])),paste(data[,1],data[,2],sep = "_x_"))
# names(solution[[2]]$varuhat)<-c(unique(c(data[,1],data[,2])),paste(data[,1],data[,2],sep = "_x_"))
# names(solution[[2]]$PEVuhat)<-c(unique(c(data[,1],data[,2])),paste(data[,1],data[,2],sep = "_x_"))
