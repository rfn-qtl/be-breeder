...
######################################################################################
###                                                                                ###
### Be-Breeder 2.1 is a R/Shiny application for statistical analysis and plant     ###
### breeding developed by Prof. Dr. Roberto Fritsche-Neto, Dr. Filipe Inacio       ###
### Matias, Julia S. Morosini, and Fernando Garcia Espolador, who integrated the.  ###
### Laboratory of Allogamous Plant Breeding - Department of Genetics,              ###
...
### Contact:                                                                       ###                                             ###
###                                                                                ###
### E-mail: rfn.qtl.@gmail.com                                                     ###
###         filipematias23@gmail.com                                               ###
###                                                                                ###
###                                                                                ###
######################################################################################
######################################################################################
...
# #####################################################################################################################################################################################
  ...
  header <- dashboardHeader(title = "Be-Breeder 2.1",
                            titleWidth = 250)
...
# #####################################################################################################################################################################################
      ...
      tabItem("start", box(status = "primary", height = 700, width = 600, align = "center",
                           ...
                           a(id = "web_button", class = "btn action_button",
                             href = "https://github.com/rfn-qtl/be-breeder/blob/main/Manual_BeBreeder.pdf",
...
# #####################################################################################################################################################################################
      ...
      tabItem("Lear1",
              fluidPage(
                ...
                h4(em("Here, one can observe the fluctuation in additive and dominance genetic variances between and within populations as a function of the inbreeding coefficient 
...
# ######################################################################################################################################################################################
      ...
      tabItem("Lear3",
              fluidPage(
                ...
                h4(em("Here, one can simulate the genetic structure of a trait, choosing the number of genes with dominance, partial dominance, and additive effects. The aim is to 
...
# ######################################################################################################################################################################################
      ...
      tabItem("Lear4",
              fluidPage(
                ...
                h4(em("Here, one can estimate the number of individuals to be evaluated in the progeny in order to obtain a genotype carrying a trait of interest controlled by n genes in a 
...
# ######################################################################################################################################################################################
      ...
      tabItem("Lear5",
              fluidPage(
                ...
                h4(em("Here, one can simulate different scenarios to understand how a locus with 2 alleles is affected by selection regarding the Hardy-Weinberg equilibrium (HWE) according to 
                      the number of genotypes (original and selected), their correspondent phenotypic value, inbreeding rate, and broad-sense heritability", style = "color:gray")),
                br(),
                sidebarLayout(
                  sidebarPanel(
                    ...
                    sliderInput("Lear5.41","Inbreeding rate",0,1,0),
...
# ######################################################################################################################################################################################
      ...
      tabItem("Lear6",
              fluidPage(
                ...
                h4(em("Here, one can set up the additive (a) and dominance (d) effects of a locus with two alleles (p and q) in order to observe how they impact on 
...
# ######################################################################################################################################################################################
      ...
      tabItem("Lear7",
              fluidPage(
                ...
                h4(em("Here, the aim is to visualize how the number of alleles of a gene related to genetic variability due to heterozygosity. The user provides the number of alleles
                      and their respective initial frequencies in the population composition.", style = "color:gray")),
                br(),
                sidebarLayout(
                  sidebarPanel(
      ...
      tabItem("Lear8",
              fluidPage(
                ...
                h4(em("Considering the IRS breeding scheme, the user can simulate different selection scenarios defining the evaluation and recombination units and derived parameters to obtain 
                      the estimates of response to selection, effective population size (Ne), and inbreeding rate (Wright'F)", style = "color:gray")),
                br(),
                sidebarLayout(
                  sidebarPanel(
                    radioButtons('Lear8.1', '| Evaluation/Recombination | c | D1 | Ne |',
                                 c("| HS/HS | 1/4 | 0 |  4  |"='HS/HS',
                                   "| HS/S1 | 1/2 | 0 |  1  |"='HS/S1',
                                   "| FS/FS | 1/2 | 0 |  2  |"='FS/FS',
                                   "| FS/S1 | 1/2 | 0 |  1  |"='FS/S1',
                                   "| S1/S1 |  1  |1/2|  1  |"='S1/S1',
      ...
      tabItem("Lear81",
              fluidPage(
                ...
                h4(em("Considering the RRS breeding scheme, the user can simulate different selection scenarios defining the evaluation and recombination units and derived parameters to obtain 
                      the estimates of response to selection, effective population size (Ne), and inbreeding rate (Wright'F) for each heterotic group", style = "color:gray")),
                br(),
                sidebarLayout(
                  sidebarPanel(
...
# ######################################################################################################################################################################################
      ...
      tabItem("Lear10",
              fluidPage(
                ...
                h4(em("Here, one can simulate different degrees of interaction considering three genotypes and two environments in order to verify how the GxE interaction influences the variances
                ...
                sidebarLayout(
                  sidebarPanel(
                    ...
                    helpText("ABOUT:"),
                    helpText("Equations for this tab are detailed on GitHub:", a(href="https://github.com/filipematias23/Be-Breeder/", "https://github.com/filipematias23/Be-Breeder/", "https://github.com/rfn-qtl/be-breeder", target="_blank"))),
...
# ######################################################################################################################################################################################
      ...
      tabItem("Lear11",
              fluidPage(
                ...
                h4(em("The aim in here is to understand how the heterosis fluctuates according to the number of genes, the dominance deviations, and the genetic divergence between
...
# #####################################################################################################################################################################################      
      ...
      tabItem("Lear12",
              fluidPage(
                ...
                h4(em("In here, the user can determine the effect of testers in order to verify their impacts on the testecrosses genetic variability", style = "color:gray")),
                br(),
                sidebarLayout(
                  sidebarPanel(
                    ...
                    sliderInput("Lear12.5","Inbreeding rate (F)",0,1,0),
...
# #####################################################################################################################################################################################      
      ...
      tabItem("Lear13",
              fluidPage(
                ...
                h4(em("Here, one can understand how the occurrence of genetic drift is influenced by the allele frequency (q) and the selection intensity. From that, 
...
# #####################################################################################################################################################################################      
      ...
      tabItem("Lear14",
              fluidPage(
                ...
                h4(em("Here, the user can verify the possibility of selecting a trait based on another, which is called indirect selection. Providing the values for the parameters
                      requested, it is possible to calculate the eficiency of the indirect response to selection", style = "color:gray")),
                br(),
                sidebarLayout(
                  sidebarPanel(
                    sliderInput("Lear14.1","Trait heritability 'x'",0,1,0),
...
# #####################################################################################################################################################################################
      ...
      tabItem("Lear16",
              fluidPage(
                ...
                h4(em("Here, the user here may infer about the trade-off between number of replicates and population size, and their effect on  
                      response to selection (RS)", style = "color:gray")),
                br(),
                sidebarLayout(
                  sidebarPanel(
                    sliderInput("Lear16.1","Number of replicates",1,5,1),
                    numericInput("Lear16.2","Number of field plots available",min = 0,value = 0),
...
# #####################################################################################################################################################################################
      ...
      tabItem("Lear17",
              fluidPage(
                ...
                h4(em("Here, the aim is to provide a broader ideia about the breeding process costs, considering the cost per plot, trait heritability, and the expected genetic gain.", style = "color:gray")),
                br(),
                sidebarLayout(
                  sidebarPanel(
...
# ######################################################################################################################################################################################
      ...
      tabItem("Lear18",
              fluidPage(
                ...
                h4(em("Here, one can simulate different scenearios of LD, informing the haplotypes and allele frequencies.", 
                      style = "color:gray")),
                br(),
                sidebarLayout(
                  sidebarPanel(
...
# ######################################################################################################################################################################################
      ...
      tabItem("Lear19",
              fluidPage(
                titlePanel("Cycles to dissipate LD"),
                h4(em("Here, it is possible to estimate how many cycles are needed to dissipate the LD by recombination", style = "color:gray")),
                br(),
                sidebarLayout(
                  sidebarPanel(
                    sliderInput("Lear19.1","Loss of LD (%)",0,100,5),
                    sliderInput("Lear19.2","Recombination rate between loci",0,0.5,0.05),
...
Dr. Filipe Inacio Matias, and Dr. Julia Silva Morosini, who integrated the Laboratory of Allogamous Plant Breeding group - Department of Genetics,
'Luiz de Queiroz' College of Agriculture, University of Sao Paulo, Brazil.")),
br(),
br(),
...
br(),
br(),
box(status = "primary", height = 600, width = 500, align = "center",
    br(),
    fluidRow(
a(id = "web_button", class = "btn action_button",
  href = "http://dx.doi.org/10.2135/cropsci2018.10.0621le",
  img(src="geral.jpeg", height = "80%", width = "80%", align = "center"))
),
br()
))),
      ...
      tabItem("info2",
              fluidPage(
                titlePanel("Citation"),
                br(),
                h4(em("1. Matias FI, Morosini JS, Espolador FG, Fritsche-Neto R (2019) Be-breeder 2.0: a web application for genetic analyses in a plant breeding context. Crop Science. 59:1371-1373.",
a(href="http://dx.doi.org/10.2135/cropsci2018.10.0621le", "http://dx.doi.org/10.2135/cropsci2018.10.0621le", target="_blank"),
h1(),
"2. Matias, Filipe Inacio;  Granato, Italo Stefanine Correa; Fritsche-Neto, Roberto. (2018). Be-Breeder: an R/Shiny application for phenotypic data analyses in plant breeding.
...
h1(),
"3. Matias, Filipe Inacio, Granato, Italo Stefanine Correa, Dequigiovanni, Gabriel, & Fritsche-Neto, Roberto. (2017). Be-Breeder - an application for analysis of genomic data in plant breeding. 
...
h1(),
"4. Fritsche-Neto, Roberto, & Matias, Filipe Inacio. (2016). Be-Breeder - Learning: a new tool for teaching and learning plant breeding principles. 
...
h1()
      ...
      tabItem("info3",
              ...
              h1(),
                strong("Roberto Fritsche Neto"), "- rfn.qtl@gmail.com",
              a(id = "web_button", class = "btn action_button",
              ...
              br(),
                strong("Filipe Inácio Matias"), "- filipematias23@gmail.com",
              a(id = "web_button", class = "btn action_button",
...
# #####################################################################################################################################################################################
      ...
      cont.Lear.8a <- reactive({
        if(input$Lear8.1=='HS/HS'){D1=0;c=(1/4);Ne=4;}
        if(input$Lear8.1=='HS/S1'){D1=0;c=(1/2);Ne=1;}
        if(input$Lear8.1=='FS/FS'){D1=0;c=(1/2);Ne=2;}
        if(input$Lear8.1=='FS/S1'){D1=0;c=(1/2);Ne=1;}
...
# #####################################################################################################################################################################################
     ...
     # Lean.8.1
      ...
      cont.Lear.8.1a <- reactive({
        if(input$Lear81.1=='HS/HS'){c=(1/8);Ne=4;}
        if(input$Lear81.1=='HS/S1'){c=(1/4);Ne=1;}
        if(input$Lear81.1=='TC/HS'){c=(1/16);Ne=4;}
        if(input$Lear81.1=='FS/S1'){c=(1/4);Ne=1;}
        I<-function(persel){
          estimate<-dnorm(qnorm(1-(persel/100), 0, 1), 0, 1)/(persel/100)
          return(estimate)}
